...
public class SortController {
	...
	public void sorting(int uid) throws SQLException
   	{
       		new SortView().attributes();
		int col=new SortView().getCol();
		Connection con=new DBController().getDBConnection();
		String query="select * from contact_personel as cp inner join  contact_work as cw on cp.wid=cw.wid where uid=? ORDER BY "+arr[col-1];
